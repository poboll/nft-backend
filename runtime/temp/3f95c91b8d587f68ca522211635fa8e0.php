...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-is_manghe" class="form-control selectpicker" name="row[is_manghe]">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-goods_category_id" data-rule="required" data-source="goods_category/index" class="form-control selectpage" name="row[goods_category_id]" type="text" value="">
        </div>
    </div>    
    <div class="form-group">
    ...
    <div class="form-group is_manghe">
    ...
    <div class="form-group is_manghe">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-order" class="form-control" name="row[order]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Start_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-start_time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[start_time]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('End_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-end_time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[end_time]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group is_manghe">
    ...
    <div class="form-group is_manghe">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-sales" class="form-control" name="row[sales]" type="number">
        </div>
    </div>
    <div class="form-group is_manghe">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Surplus'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-surplus" class="form-control" name="row[surplus]" type="number">
        </div>
    </div>
    <div class="form-group is_manghe">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Company_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-company_name" class="form-control" name="row[company_name]" type="text" value="">
        </div>
    </div>
    <div class="form-group is_manghe">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-company_image" class="form-control" size="50" name="row[company_image]" type="text" value="">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group is_manghe">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-creator" class="form-control" name="row[creator]" type="text" value="">
        </div>
    </div>
    <div class="form-group is_manghe">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Owner'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-owner" class="form-control" name="row[owner]" type="text" value="">
        </div>
    </div>
    <div class="form-group is_manghe">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Casting_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-casting_name" class="form-control" name="row[casting_name]" type="text">
        </div>
    </div>
    <div class="form-group is_manghe">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Casting_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-casting_time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[casting_time]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group is_manghe">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Token_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-token_id"   class="form-control" name="row[token_id]" type="text" value="">
        </div>
    </div>    
    <div class="form-group is_manghe">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Blockchain'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-blockchain" class="form-control" name="row[blockchain]" type="text" value="">
        </div>
    </div>
    <div class="form-group is_manghe">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Contract_address'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-contract_address" class="form-control" name="row[contract_address]" type="text" value="">
        </div>
    </div>
    <div class="form-group is_manghe">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Contract_address_url'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-contract_address_url" class="form-control" name="row[contract_address_url]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-label" class="form-control" name="row[label]" type="text" value="">
        </div>
    </div>
