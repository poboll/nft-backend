...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Total_number'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-total_number" class="form-control" name="row[total_number]" type="number" value="<?php echo htmlentities($row['total_number']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Goods_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-goods_id"  data-source="goods/index" class="form-control selectpage" name="row[goods_id]" type="text" value="<?php echo htmlentities($row['goods_id']); ?>">
        </div>
    </div>
